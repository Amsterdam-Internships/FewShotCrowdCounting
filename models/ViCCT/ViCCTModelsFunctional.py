...
from models.ViCCT.timm_functional.timm_functional import VisionTransformer_functional, _cfg
from timm.models.registry import register_model

__all__ = ['ViCCT_tiny_functional',
           'ViCCT_small_functional',
           'ViCCT_base_functional']
...
class ViCCTRegressionHead_functional(nn.Module):
...
class DistilledRegressionTransformer_functional(VisionTransformer_functional):
    def __init__(self, *args, **kwargs):
        ...
        self.regression_head = ViCCTRegressionHead_functional(kwargs['img_size'])
...
@register_model
def ViCCT_tiny_functional(init_path=None, pretrained=False, **kwargs):
...
@register_model
def ViCCT_small_functional(init_path=None, pretrained=False, **kwargs):
    model = DistilledRegressionTransformer_functional(
...
@register_model
def ViCCT_base_functional(init_path=None, pretrained=False, **kwargs):
    model = DistilledRegressionTransformer_functional(
