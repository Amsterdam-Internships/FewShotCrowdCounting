...
from .SHTA_CSRNet import SHTA_CSRNet


def loading_data():
    # train transforms
    train_main_transform = own_transforms.Compose([
        own_transforms.FixedScaleFactor(8),
    ...
    train_set = SHTA_CSRNet(cfg_data.DATA_PATH, 'train',
    ...
    val_set = SHTA_CSRNet(cfg_data.DATA_PATH, 'val',
    ...
    test_set = SHTA_CSRNet(cfg_data.DATA_PATH, 'test',
                           main_transform=val_main_transform,
                           img_transform=val_img_transform,
                           gt_transform=val_gt_transform)
