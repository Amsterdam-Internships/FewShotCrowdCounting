...
from .SHTB_DeiT_Dynamic import SHTB_DeiT_Dynamic
...
def loading_data(crop_size):
    ...
    train_random_scale = own_transforms.Compose([
    ...
    val_set = SHTB_DeiT_Dynamic(cfg_data.DATA_PATH, 'val', crop_size,
    ...
    test_set = SHTB_DeiT_Dynamic(cfg_data.DATA_PATH, 'test', crop_size,
                         main_transform=val_main_transform,
                         img_transform=val_img_transform,
                         gt_transform=val_gt_transform,
                         scaler=None,
