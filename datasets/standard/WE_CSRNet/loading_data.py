...
from .WE_CSRNet import WE_CSRNet
...
def loading_data():
    ...
    train_set = WE_CSRNet(cfg_data.DATA_PATH, 'train',
    ...
    val_set = WE_CSRNet(cfg_data.DATA_PATH, 'val',
    ...
    test_set = WE_CSRNet(cfg_data.DATA_PATH, 'test',
                         main_transform=val_main_transform,
                         img_transform=val_img_transform,
                         gt_transform=val_gt_transform)
