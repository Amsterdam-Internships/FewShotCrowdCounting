...
__C_WEMAML.LOG_PARA = 100.

__C_WEMAML.RESUME_MODEL = ''  # model path
__C_WEMAML.TRAIN_BATCH_SIZE = 12  # imgs
__C_WEMAML.TEST_BATCH_SIZE = 1  # imgs

__C_WEMAML.VAL_BATCH_SIZE = 8  #

__C_WEMAML.VAL_FOLDER = ['104207', '200608', '200702', '202201', '500717']

__C_WEMAML.NUM_OF_INSTANCES = 5
__C_WEMAML.NUM_OF_TASKS = 10
